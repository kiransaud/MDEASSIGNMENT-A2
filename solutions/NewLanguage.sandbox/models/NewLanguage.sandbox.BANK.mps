...
<model ref="r:ccdedcac-4398-48e4-9284-7e00abf146b7(NewLanguage.sandbox.BANK)">
  ...
  <registry>
    <language id="437c9db1-d8f4-4db9-b294-bc781192d511" name="NewLanguage">
      ...
      <concept id="8156410237083669055" name="NewLanguage.structure.FinancialEntity" flags="ng" index="myz7q">
        ...
        <child id="8156410237084170228" name="regulatoryEntities" index="mWTgh" />
      </concept>
      ...
      <concept id="8156410237084170231" name="NewLanguage.structure.RegulatoryEntityRef" flags="ng" index="mWTgi">
        <reference id="8156410237084170232" name="entity" index="mWTgt" />
      </concept>
  ...
  <node concept="myz5A" id="74LoYlBREQU">
    ...
    <node concept="myz6_" id="56OGMA0URFU" role="mz2P2">
      ...
      <ref role="mz4F9" node="56OGMA0X0mP" resolve="kumari bank limited" />
  ...
  <node concept="mzWCL" id="74LoYlBSRC_">
    ...
    <node concept="myz7q" id="56OGMA0X0mP" role="mzWCK">
      ...
      <property role="TrG5h" value="kumari bank limited" />
      <node concept="mWTgi" id="7QyyYBKekWV" role="mWTgh">
        <ref role="mWTgt" node="56OGMA11kuE" resolve="compliance bord rule" />
      </node>
  ...
  <node concept="myzgi" id="56OGMA10g_l">
    ...
    <node concept="myz6x" id="56OGMA10g_m" role="myzgu">
      ...
      <property role="TrG5h" value="financial rule" />
    ...
    <node concept="myz6x" id="56OGMA11kuE" role="myzgu">
      ...
      <property role="TrG5h" value="compliance bord rule" />
